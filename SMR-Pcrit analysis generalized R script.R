...
probe08.arfe <- probe08[probe08$spps == 'arfe', ] # Update as appropriate
probe08.arfe.17jun <- probe08.arfe[probe08.arfe$date.day == '17' &
                                     probe08.arfe$date.month == 'jun' , ] # Update as appropriate
#probe14.olma.trial2.16c <- probe14.olma.trial2[probe14.olma.trial2$temp == '16', ] # Update as appropriate
head(probe08.arfe.17jun) # Update as appropriate
str(probe08.arfe.17jun) # Update as appropriate

### SMR estimate function

five.hr.plus.data <- probe08.arfe.17jun[probe08.arfe.17jun$time.hrs > 5, ]
...
plot.smr <- ggplot(data=probe08.arfe.17jun, aes(x=probe08.arfe.17jun$time.hrs, 
                                                  y=probe08.arfe.17jun$mo2)) 
...
calcO2crit(pcrit.data, 1.41) # Enter value of SMR obtained above here, after "pcrit.data
#?calcO2crit

plotO2crit(calcO2crit(pcrit.data, 1.41))
